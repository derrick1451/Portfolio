...
const Hero = () => {
  ...
  const socialLinks = [
    ...
    {
      icon: <FaLinkedin />,
      url: "https://www.linkedin.com/in/okongo-derrick/",
    },
  ...
  return (
    <section
      id="home"
      className="flex items-center justify-center bg-white dark:bg-gray-900 px-8 sm:px-6 max-sm:pt-16 lg:px-8"
    >
      <motion.div
        ...
        <div className=" sm:text-left grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={itemVariants}>
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Kickstarting your vision through code. I am a certified full-stack
              web developer with a passion for building interactive web
              applications. Experienced in building responsive web applications
              using HTML, CSS, JavaScript, React, Node.js, and Ruby on Rails.
              Let's turn your ideas into exceptional digital experiences! Check
              out my portfolio and let's discuss your next project.
            </motion.p>
